 ...
 */
#ifndef PRIVATE_UI_MB_CLIPPER_H_
#define PRIVATE_UI_MB_CLIPPER_H_
...
namespace lsp
{
    namespace plugui
    {
         ...
         */
        class mb_clipper_ui: public ui::Module, public ui::IPortListener
        {
            protected:
...
#endif /* PRIVATE_UI_MB_CLIPPER_H_ */
